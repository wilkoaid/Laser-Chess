...
public class Board {
	...
	public void initialiseBoardACE() {
		...
		// set white pieces
		Tile j8 = new Tile(new Laser(Colour.WHITE, 0, new ImageView("resources/pieces/white_laser.png")), File.J, Rank.EIGHT);
		this.board[getArrayIndex(File.J,Rank.EIGHT)] = j8;
		this.whiteLaserTile = j8;
		
		Tile f8 = new Tile(new Defender(Colour.WHITE, 0, new ImageView("resources/pieces/white_defender.png")) ,File.F,Rank.EIGHT);
		this.board[getArrayIndex(File.F,Rank.EIGHT)] = f8;
		
		Tile e8 = new Tile(new King(Colour.WHITE, 0, new ImageView("resources/pieces/white_king.png")),File.E,Rank.EIGHT);
		this.board[getArrayIndex(File.E,Rank.EIGHT)] = e8;
		
		Tile d8 = new Tile(new Defender(Colour.WHITE, 0, new ImageView("resources/pieces/white_defender.png")) ,File.D,Rank.EIGHT);
		this.board[getArrayIndex(File.D,Rank.EIGHT)] = d8;
		
		Tile c8 = new Tile(new Deflector(Colour.WHITE, 315, new ImageView("resources/pieces/white_deflector.png")),File.C,Rank.EIGHT);
		this.board[getArrayIndex(File.C,Rank.EIGHT)] = c8;
		
		Tile h7 = new Tile(new Deflector(Colour.WHITE, 45, new ImageView("resources/pieces/white_deflector.png")),File.H,Rank.SEVEN);
		this.board[getArrayIndex(File.H,Rank.SEVEN)] = h7;
		
		Tile j5 = new Tile(new Deflector(Colour.WHITE, 225, new ImageView("resources/pieces/white_deflector.png")),File.J,Rank.FIVE);
		this.board[getArrayIndex(File.J,Rank.FIVE)] = j5;
		
		Tile f5 = new Tile(new Switch(Colour.WHITE, 45, new ImageView("resources/pieces/white_switch.png")),File.F,Rank.FIVE);
		this.board[getArrayIndex(File.F,Rank.FIVE)] = f5;
		
		Tile e5 = new Tile(new Switch(Colour.WHITE, 135, new ImageView("resources/pieces/white_switch.png")),File.E,Rank.FIVE);
		this.board[getArrayIndex(File.E,Rank.FIVE)] = e5;
		
		Tile c5 = new Tile(new Deflector(Colour.WHITE, 315, new ImageView("resources/pieces/white_deflector.png")),File.C,Rank.FIVE);
		this.board[getArrayIndex(File.C,Rank.FIVE)] = c5;
		
		Tile j4 = new Tile(new Deflector(Colour.WHITE, 315, new ImageView("resources/pieces/white_deflector.png")),File.J,Rank.FOUR);
		this.board[getArrayIndex(File.J,Rank.FOUR)] = j4;
		
		Tile c4 = new Tile(new Deflector(Colour.WHITE, 225, new ImageView("resources/pieces/white_deflector.png")),File.C,Rank.FOUR);
		this.board[getArrayIndex(File.C,Rank.FOUR)] = c4;
		
		Tile d3 = new Tile(new Deflector(Colour.WHITE, 315, new ImageView("resources/pieces/white_deflector.png")),File.D,Rank.THREE);
		this.board[getArrayIndex(File.D,Rank.THREE)] = d3;
		
		
		// set black pieces
		Tile a1 = new Tile(new Laser(Colour.BLACK, 180, new ImageView("resources/pieces/black_laser.png")),File.A,Rank.ONE);
		this.board[getArrayIndex(File.A,Rank.ONE)] = a1;
		this.blackLaserTile = a1;
		
		Tile e1 = new Tile(new Defender(Colour.BLACK, 180, new ImageView("resources/pieces/black_defender.png")),File.E,Rank.ONE);
		this.board[getArrayIndex(File.E,Rank.ONE)] = e1;
		
		Tile f1 = new Tile(new King(Colour.BLACK, 180, new ImageView("resources/pieces/black_king.png")),File.F,Rank.ONE);
		this.board[getArrayIndex(File.F,Rank.ONE)] = f1;
		
		Tile g1 = new Tile(new Defender(Colour.BLACK, 180, new ImageView("resources/pieces/black_defender.png")),File.G,Rank.ONE);
		this.board[getArrayIndex(File.G,Rank.ONE)] = g1;
		
		Tile h1 = new Tile(new Deflector(Colour.BLACK, 135, new ImageView("resources/pieces/black_deflector.png")),File.H,Rank.ONE);
		this.board[getArrayIndex(File.H,Rank.ONE)] = h1;
		
		Tile c2 = new Tile(new Deflector(Colour.BLACK, 225, new ImageView("resources/pieces/black_deflector.png")),File.C,Rank.TWO);
		this.board[getArrayIndex(File.C,Rank.TWO)] = c2;
		
		Tile a4 = new Tile(new Deflector(Colour.BLACK, 45, new ImageView("resources/pieces/black_deflector.png")),File.A,Rank.FOUR);
		this.board[getArrayIndex(File.A,Rank.FOUR)] = a4;
		
		Tile e4 = new Tile(new Switch(Colour.BLACK, 45, new ImageView("resources/pieces/black_switch.png")),File.E,Rank.FOUR);
		this.board[getArrayIndex(File.E,Rank.FOUR)] = e4;
		
		Tile f4 = new Tile(new Switch(Colour.BLACK, 135, new ImageView("resources/pieces/black_switch.png")),File.F,Rank.FOUR);
		this.board[getArrayIndex(File.F,Rank.FOUR)] = f4;
		
		Tile h4 = new Tile(new Deflector(Colour.BLACK, 135, new ImageView("resources/pieces/black_deflector.png")),File.H,Rank.FOUR);
		this.board[getArrayIndex(File.H,Rank.FOUR)] = h4;
		
		Tile a5 = new Tile(new Deflector(Colour.BLACK, 135, new ImageView("resources/pieces/black_deflector.png")),File.A,Rank.FIVE);
		this.board[getArrayIndex(File.A,Rank.FIVE)] = a5;
		
		Tile h5 = new Tile(new Deflector(Colour.BLACK, 45, new ImageView("resources/pieces/black_deflector.png")),File.H,Rank.FIVE);
		this.board[getArrayIndex(File.H,Rank.FIVE)] = h5;
		
		Tile g6 = new Tile(new Deflector(Colour.BLACK, 135, new ImageView("resources/pieces/black_deflector.png")),File.G,Rank.SIX);
